...
## [Settings](https://github.com/loguru-log/TapSwap/blob/main/.env-example)
| Setting                  | Description                                                                              |
|--------------------------|------------------------------------------------------------------------------------------|
...
## Installation
You can download [**Repository**](https://github.com/loguru-log/TapSwap) by cloning it to your system and installing the necessary dependencies:
```shell
~ >>> git clone https://github.com/loguru-log/TapSwap.git
~ >>> cd TapSwap
